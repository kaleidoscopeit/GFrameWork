...
function str(rot){
	...
	nav.uri='/images';
	nav.ock=function(){
		if(this.itemMime!='inode')image.src='../../'+rot+'/images/'+this.itemURL+'/'+this.itemName;
		pst.value='images/'+this.itemURL+'/'+this.itemName;
	};
	nav.odck=function(){
	...
	prv=pst.value;
	/* imposta l'area immagine con quella attuale*/
	image.src='../../'+rot+'/'+pst.value;
}
