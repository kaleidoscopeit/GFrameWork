		...
		<style>
 		...
 		<script type="text/JavaScript">
   		...
   		function ups(){
   			...
   			if(pv!=dge('sel').value){
   				wop.wnd[oid].wbt.updatePrpty('FIELDS','',vt);
					wop.wnd[oid].wbt.updatePrpty('KEYFIELD','',vt);
   			}
				wop.wnd[oid].wbt.updatePrpty(pn,dge('sel').value,vt);
				wop.wnd[oid].wbt.upPrptyBox();
				self.close();
			}
 		</script>
